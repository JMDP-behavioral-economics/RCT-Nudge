...
wildbs_subset_stock(use$stock, male == 1 & age < 30, "CR2", TRUE, treat = c("B", "D")) %>%
  tbl()
```

```{r wildbs-young-male-coordination, tbl.cap = 'Linear Probability Model of Coordination among Males'}
wildbs_subset_coordination(use$coordination, male == 1 & age < 30, "CR2", "TRUE", "B") %>%
  tbl()
```
