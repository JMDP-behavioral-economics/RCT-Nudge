...
lm_all_stock(use$stock[stock_young_male,], FALSE, "stata", TRUE) %>%
  tbl()
...
lm_all_coordination(use$coordination[coord_young_male, ], FALSE, "stata", TRUE) %>%
  tbl()
