...
In the control group, approximately 50($=38.6/74.4$)% of males in their 20s who responded to the compatibility notice were willing to donate, which is lower than the willingness rate of respondents in the other gender and age groups.[^cal] experimental arm B (Probability message) raises the intention rate of male respondents in their 20s from 50% to 60% ($=(38.6 + 10)/(74.4 + 6)$). In addition, young men are reported to have better transplant outcomes than other genders and ages [e.g., @Kollman2016]. Taken together, we can say that the Probability message improves the efficiency of coordination in the sense that it encourages behavioral change (initiation of coordination) in desirable donors.
