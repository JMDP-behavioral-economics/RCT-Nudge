...
```{r reg-primaries, include = FALSE, eval = FALSE}
...
```{r tab-reg-primaries, eval = FALSE}
reg_primaries %>%
...
```{r hetero-gender-age-primaries, include = FALSE, eval = FALSE}
est <- testdt %>%
  mutate(outcome = factor(outcome, out_lev, out_lab)) %>%
...
```{r plotB-hetero-gender-age-primaries, fig.width = 10, fig.height=7, eval = FALSE}
est %>%
...
```{r plotC-hetero-gender-age-primaries, fig.width = 10, fig.height=7, eval = FALSE}
est %>%
...
```{r plotD-hetero-gender-age-primaries, fig.width = 10, fig.height=7, eval = FALSE}
est %>%
