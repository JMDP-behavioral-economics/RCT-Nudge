...
- 性別と年齢（30歳以下どうか）でサンプルを分割して、返信と意向の効果を推定する
  - **若年男性は移植実績が良いとされているが、具体的に、若年とは何歳以下か？**
...
plot_list <- 2:4 %>%
  purrr::map(function(x) {
    hetero_reply %>%
      ...
      labs(
        title = paste("Panel", LETTERS[x - 1]),
        x = "Subset",
        y = paste("Effect of Message", LETTERS[x], "\n(95%CI)"),
