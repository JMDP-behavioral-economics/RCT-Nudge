...
```{r plotB-change-age-threshold, fig.width=15, fig.height=10}
age_criterion %>%
...
```{r plotC-change-age-threshold, fig.width=15, fig.height=10}
age_criterion %>%
...
```{r plotD-change-age-threshold, fig.width=15, fig.height=10}
age_criterion %>%
...
```{r plot-hospital-per-area, fig.width=10, fig.height=7}
hospital %>%
  ggplot(aes(
...
```{r geographical-hetero-primaries, include = FALSE}
est <- testdt %>%
...
```{r plotB-geographical-hetero-primaries, fig.width = 10, fig.height=7}
est %>%
  dplyr::filter(treat == "B") %>%
...
```{r plotC-geographical-hetero-primaries, fig.width = 10, fig.height=7}
est %>%
  dplyr::filter(treat == "C") %>%
  ggplot(aes(x = qt_hospital, y = estimate)) +
    geom_hline(aes(yintercept = 0), linetype = 2) +
...
```{r plotD-geographical-hetero-primaries, fig.width = 10, fig.height=7}
est %>%
  dplyr::filter(treat == "D") %>%
  ggplot(aes(x = qt_hospital, y = estimate)) +
    geom_hline(aes(yintercept = 0), linetype = 2) +
