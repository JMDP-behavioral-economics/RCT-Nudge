...
\begin{figure}[t]
\includegraphics{body_files/figure-latex/boxplot-rcf-int-1} \caption{Boxplot of Predicted Treatment Effects by Gender and Age. Notes: Blue fitted line represents GAM smoothing. Covariates are gender, age, number of past coordinations, number of hospitals per 10 square kilometers, number of hospitals with PBSC collection per 10 square kilometers and number of hospitals with BM collection per 10 square kilometers.}\label{fig:boxplot-rcf-int}
\end{figure}
...
\cmidrule(l{3pt}r{3pt}){2-2} \cmidrule(l{3pt}r{3pt}){3-3} \cmidrule(l{3pt}r{3pt}){4-4} \cmidrule(l{3pt}r{3pt}){5-5}
 & (1) & (2) & (3) & (4)\\
\midrule
B & -0.0002 & -0.0112 & 0.1237*** & 0.0199\\
 & (0.0468) & (0.0287) & (0.0403) & (0.0214)\\
C & 0.0432 & -0.0195 & 0.0470 & -0.0116\\
 & (0.0473) & (0.0296) & (0.0413) & (0.0226)\\
D & -0.0545 & 0.0071 & 0.0422 & 0.0217\\
 & (0.0475) & (0.0291) & (0.0407) & (0.0220)\\
\bottomrule
\end{tabular}
\begin{tablenotes}
...
\cmidrule(l{3pt}r{3pt}){2-2} \cmidrule(l{3pt}r{3pt}){3-3} \cmidrule(l{3pt}r{3pt}){4-4}
 & (1) & (2) & (3)\\
\midrule
Age & 35.675 & 37.582 & < 0.001\\
Number of past coordinations & 1.647 & 2.745 & < 0.001\\
Number of listed hospitals & 0.394 & 1.432 & < 0.001\\
Number of hospitals listed with PBSC collection & 0.132 & 0.503 & < 0.001\\
Number of hospitals listed with BM collection & 0.198 & 0.853 & < 0.001\\
N & 9101 & 1948 & \\
\bottomrule
\end{tabular}
\begin{tablenotes}
...
\cmidrule(l{3pt}r{3pt}){2-2} \cmidrule(l{3pt}r{3pt}){3-3} \cmidrule(l{3pt}r{3pt}){4-4}
 & (1) & (2) & (3)\\
\midrule
Age & 48.725 & 49.894 & < 0.001\\
Number of past coordinations & 1.800 & 1.861 & 0.297\\
Number of listed hospitals & 0.566 & 0.400 & < 0.001\\
Number of hospitals listed with PBSC collection & 0.191 & 0.135 & < 0.001\\
Number of hospitals listed with BM collection & 0.317 & 0.188 & < 0.001\\
N & 9054 & 1995 & \\
\bottomrule
\end{tabular}
\begin{tablenotes}
...
\cmidrule(l{3pt}r{3pt}){2-2} \cmidrule(l{3pt}r{3pt}){3-3} \cmidrule(l{3pt}r{3pt}){4-4}
 & (1) & (2) & (3)\\
\midrule
Age & 48.534 & 50.124 & < 0.001\\
Number of past coordinations & 1.625 & 1.556 & 0.281\\
Number of listed hospitals & 0.542 & 0.428 & 0.004\\
Number of hospitals listed with PBSC collection & 0.162 & 0.161 & 0.974\\
Number of hospitals listed with BM collection & 0.290 & 0.218 & 0.002\\
N & 9993 & 1056 & \\
\bottomrule
\end{tabular}
\begin{tablenotes}
