#' ---
#' title: Random Causal Forest (Reply with Positive Intention)
#' ---
#'
...
#+ rcf-positive-run, include = FALSE
...
#+ rcf-positive-data, include = FALSE
age_group <- list(
  "Age: 20-29" = X[, 2] < 30,
...
#+ rcf-positive-dist, fig.width = 10, fig.cap = "Heterogenous Message Effects on Positive Intention."
...
#+ rcf-positive-male-dist, fig.width = 10, fig.height = 10, fig.cap = "Heterogenous Message Effects on Positive Intention among Males."
...
#+ rcf-positive-female-dist, fig.width = 10, fig.height = 10, fig.cap = "Heterogeneous Message Effects on Positive Intention among Females."
