...
#' subtitle: Coordination Process (Final Consent)
#' ---
#'
...
use <- rawdt %>%
  ...
  dplyr::filter(exg_stop_consent == 0)

#+ rcf-consent-run, include = FALSE
...
#+ rcf-consent-data, include = FALSE
age_group <- list(
  "Age: 20-29" = X[, 2] < 30,
...
#+ rcf-consent-dist, fig.width = 10, fig.cap = "Heterogenous Message Effects on Final Consent."
...
#+ rcf-consent-male-dist, fig.width=10, fig.height=10, fig.cap="Heterogenous Message Effects on Final Consent among Males."
...
#+ rcf-consent-female-dist, fig.width=10, fig.height=10, fig.cap = "Heterogenous Message Effects on Final Consent among Females."
