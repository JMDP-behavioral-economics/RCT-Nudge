...
prime$
  ...
  kable(
    font_size = 16,
    notes = "* p < 0.1, ** p < 0.05, *** p < 0.01. The robust standard errors are in parentheses. The age category is defined as under 25 years old or older."
  )
```

```{r}
(0.050 - 0.066 * (1566 / 2422)) / ((2422 - 1566) / 2422)
(0.023 - 0.026 * (5333 / 6081)) / ((6081 - 5333) / 6081)
```
...
prime$
  ...
  kable(
    font_size = 16,
    notes = "* p < 0.1, ** p < 0.05, *** p < 0.01. The robust standard errors are in parentheses. The age category is defined as under 30 years old or older."
  )
```
...
prime$
  ...
  kable(
    font_size = 16,
    notes = "* p < 0.1, ** p < 0.05, *** p < 0.01. The robust standard errors are in parentheses. The age category is defined as under 35 years old or older."
  )
```
...
prime$
  ...
  kable(
    font_size = 16,
    notes = "* p < 0.1, ** p < 0.05, *** p < 0.01. The robust standard errors are in parentheses. The age category is defined as under 40 years old or older."
  )
```
