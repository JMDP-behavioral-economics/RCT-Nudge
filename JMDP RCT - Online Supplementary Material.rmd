...
```{r dist-response-speed, fig.cap = "Density of Number of Days Required for Reply"}
rct$
  flow(outcome = c("reply"))$
  plot_density(
    upper_days = 50,
...
```{r}
FlowFitSegment$debug("kable_lh")

rct$
  flow(outcome = c("reply"))$
  fit_segment(scale = 100, interaction_of_gender = TRUE)$
  kable_lh()

str_split("Treatment B_Young female", "_", simplify = TRUE)[, 1]
```
