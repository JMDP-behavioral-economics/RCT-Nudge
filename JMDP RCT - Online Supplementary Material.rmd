...
hypothesis <- c(
  "treatB + treatB:groupMale" = "Treatment B",
  "treatC + treatC:groupMale" = "Treatment C",
  "treatD + treatD:groupMale" = "Treatment D"
)
...
hypothesis <- c(
  "treatB + treatB:coordinate1" = "Treatment B",
  "treatC + treatC:coordinate1" = "Treatment C",
  "treatD + treatD:coordinate1" = "Treatment D"
)
...
res %>%
  ...
  modelsummary(
    ...
    coef_map = c(
      ...
      "treatB:coordinate1" = "Treatment B $\\times$ First-time coordination",
      "treatC:coordinate1" = "Treatment C $\\times$ First-time coordination",
      "treatD:coordinate1" = "Treatment D $\\times$ First-time coordination"
    ),
    gof_omit = "R2|AIC|BIC|Log|Std|FE|se_type|RMSE",
    align = "lcc",
    stars = c("***" = .01, "**" = .05, "*" = .1),
  ...
  kableExtra::group_rows(
    "Linear combination test: Treatment + Treatment $\\times$ First-Time Coordination",
    15, 20,
    bold = FALSE, italic = TRUE,
    escape = FALSE
  ) %>%
...
fit_mods %>%
  ...
  kableExtra::kable_styling(font_size = 8, latex_options = "HOLD_position") %>%
  kableExtra::add_header_above(c(" " = 1, "Candidate selection" = 4)) %>%
  kableExtra::footnote(
    general_title = "",
