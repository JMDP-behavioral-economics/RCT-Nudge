...
```{r density-response-by-intention-1, fig.cap = "Distribution of Response Speed by Intention (StatusQuo Group vs. MatchMessage Group). \\newline \\emph{Note}: We excluded those who skipped CT. We only show the density up to 40 days after the HLA match letter was sent because there was no remarkable change in the response rate thereafter.", fig.width = 20}
