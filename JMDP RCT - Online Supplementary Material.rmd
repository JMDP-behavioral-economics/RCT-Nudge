...
rct$
  ...
  kable_reg(
    ...
    coef_map_lm = c(
      ...
      "treatD" = "Experimental group D",
      "male" = "Male",
      "treatB:male" = "Experimental group B $\\times$ Male",
      "treatC:male" = "Experimental group C $\\times$ Male",
      "treatD:male" = "Experimental group D $\\times$ Male"
    ),
    coef_map_lh = c(
      "treatB + treatB:male" = "Experimental group B",
      "treatC + treatC:male" = "Experimental group C",
      "treatD + treatD:male" = "Experimental group D"
    ),
