...
\cmidrule(l{3pt}r{3pt}){2-2} \cmidrule(l{3pt}r{3pt}){3-3} \cmidrule(l{3pt}r{3pt}){4-4} \cmidrule(l{3pt}r{3pt}){5-5}
 & (1) & (2) & (3) & (4)\\
\midrule
B & -0.0072 & -0.0071 & 0.1206*** & 0.0217\\
 & (0.0471) & (0.0285) & (0.0401) & (0.0213)\\
C & 0.0488 & -0.0154 & 0.0438 & -0.0082\\
 & (0.0478) & (0.0297) & (0.0409) & (0.0226)\\
D & -0.0522 & 0.0101 & 0.0424 & 0.0237\\
 & (0.0475) & (0.0291) & (0.0401) & (0.0221)\\
\bottomrule
\end{tabular}
\begin{tablenotes}
...
\cmidrule(l{3pt}r{3pt}){2-2} \cmidrule(l{3pt}r{3pt}){3-3} \cmidrule(l{3pt}r{3pt}){4-4}
 & (1) & (2) & (3)\\
\midrule
Age & 35.681 & 37.611 & < 0.001\\
Number of past coordinations & 1.664 & 2.489 & < 0.001\\
Number of listed hospitals & 0.400 & 1.395 & < 0.001\\
Number of hospitals listed with PBSC collection & 0.136 & 0.458 & < 0.001\\
Number of hospitals listed with BM collection & 0.202 & 0.821 & < 0.001\\
N & 9101 & 1948 & \\
\bottomrule
\end{tabular}
\begin{tablenotes}
...
\cmidrule(l{3pt}r{3pt}){2-2} \cmidrule(l{3pt}r{3pt}){3-3} \cmidrule(l{3pt}r{3pt}){4-4}
 & (1) & (2) & (3)\\
\midrule
Age & 48.691 & 49.912 & < 0.001\\
Number of past coordinations & 1.770 & 1.878 & 0.063\\
Number of listed hospitals & 0.568 & 0.400 & < 0.001\\
Number of hospitals listed with PBSC collection & 0.193 & 0.135 & < 0.001\\
Number of hospitals listed with BM collection & 0.319 & 0.187 & < 0.001\\
N & 9054 & 1995 & \\
\bottomrule
\end{tabular}
\begin{tablenotes}
...
\cmidrule(l{3pt}r{3pt}){2-2} \cmidrule(l{3pt}r{3pt}){3-3} \cmidrule(l{3pt}r{3pt}){4-4}
 & (1) & (2) & (3)\\
\midrule
Age & 48.502 & 50.112 & < 0.001\\
Number of past coordinations & 1.647 & 1.544 & 0.109\\
Number of listed hospitals & 0.557 & 0.420 & 0.001\\
Number of hospitals listed with PBSC collection & 0.166 & 0.158 & 0.571\\
Number of hospitals listed with BM collection & 0.298 & 0.214 & < 0.001\\
N & 9993 & 1056 & \\
\bottomrule
\end{tabular}
\begin{tablenotes}
