...
\begin{figure}[t]
\includegraphics{JMDP RCT - Main Document (Robust)_files/figure-latex/coefplot-reg-stock-subset-1} \caption{Effect on Reply and Intentions by Gender and Age Group. Notes: These plots show the average effect (and associated 95 percent confidential interval) on each outcome by gender and age group. We use robust standard errors. We control number of past coordinations, number of hospitals per 10 square kilometers, number of hospitals with PBSC collection per 10 square kilometers, number of hospitals with BM collection per 10 square kilometers, month and week dummies.}\label{fig:coefplot-reg-stock-subset}
\end{figure}
...
\begin{figure}[t]
\includegraphics{JMDP RCT - Main Document (Robust)_files/figure-latex/boxplot-rcf-int-1} \caption{Boxplot of Predicted Treatment Effects by Treatment, Gender and Age. Notes: Fitted line represents GAM smoothing. Covariates are gender, age, number of past coordinations, number of hospitals per 10 square kilometers, number of hospitals with PBSC collection per 10 square kilometers and number of hospitals with BM collection per 10 square kilometers.}\label{fig:boxplot-rcf-int}
\end{figure}
...
\begin{figure}[t]
\includegraphics{JMDP RCT - Main Document (Robust)_files/figure-latex/cumulative-response-rate-1} \caption{Cumulative Response Rates by Gender and Age Group.}\label{fig:cumulative-response-rate}
\end{figure}
...
\begin{figure}[t]
\includegraphics{JMDP RCT - Main Document (Robust)_files/figure-latex/coefplot-reg-subsample-coordination-1} \caption{Effect on Coordination by Gender and Age Group. Note: These plots show the average effect (and associated 95 percent confidential interval) on each outcome by gender and age group. We use robust standard errors. We control number of past coordinations, number of hospitals per 10 square kilometers, number of hospitals with PBSC collection per 10 square kilometers, number of hospitals with BM collection per 10 square kilometers, month dummies, and week dummies.}\label{fig:coefplot-reg-subsample-coordination}
\end{figure}
...
\cmidrule(l{3pt}r{3pt}){2-2} \cmidrule(l{3pt}r{3pt}){3-3} \cmidrule(l{3pt}r{3pt}){4-4} \cmidrule(l{3pt}r{3pt}){5-5}
 & (1) & (2) & (3) & (4)\\
\midrule
B & -0.0046 & -0.0081 & 0.1299*** & 0.0185\\
 & (0.0475) & (0.0285) & (0.0399) & (0.0213)\\
C & 0.0456 & -0.0160 & 0.0490 & -0.0103\\
 & (0.0481) & (0.0295) & (0.0411) & (0.0224)\\
D & -0.0605 & 0.0079 & 0.0465 & 0.0228\\
 & (0.0482) & (0.0289) & (0.0401) & (0.0220)\\
\bottomrule
\end{tabular}
\begin{tablenotes}
...
\cmidrule(l{3pt}r{3pt}){2-2} \cmidrule(l{3pt}r{3pt}){3-3} \cmidrule(l{3pt}r{3pt}){4-4}
 & (1) & (2) & (3)\\
\midrule
Age & 35.682 & 37.521 & < 0.001\\
Number of past coordinations & 1.656 & 2.617 & < 0.001\\
...
\cmidrule(l{3pt}r{3pt}){2-2} \cmidrule(l{3pt}r{3pt}){3-3} \cmidrule(l{3pt}r{3pt}){4-4}
 & (1) & (2) & (3)\\
\midrule
Age & 48.699 & 49.930 & < 0.001\\
Number of past coordinations & 1.795 & 1.865 & 0.226\\
Number of listed hospitals & 0.557 & 0.403 & < 0.001\\
Number of hospitals listed with PBSC collection & 0.188 & 0.136 & < 0.001\\
Number of hospitals listed with BM collection & 0.313 & 0.188 & < 0.001\\
N & 9054 & 1995 & \\
\bottomrule
\end{tabular}
\begin{tablenotes}
...
\cmidrule(l{3pt}r{3pt}){2-2} \cmidrule(l{3pt}r{3pt}){3-3} \cmidrule(l{3pt}r{3pt}){4-4}
 & (1) & (2) & (3)\\
\midrule
Age & 48.420 & 50.141 & < 0.001\\
Number of past coordinations & 1.672 & 1.530 & 0.030\\
Number of listed hospitals & 0.530 & 0.439 & 0.024\\
Number of hospitals listed with PBSC collection & 0.157 & 0.164 & 0.652\\
Number of hospitals listed with BM collection & 0.282 & 0.225 & 0.018\\
N & 9993 & 1056 & \\
\bottomrule
\end{tabular}
\begin{tablenotes}
