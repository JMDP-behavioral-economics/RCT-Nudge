...
BothMessage group & \num{-1.91} & \num{-1.28} & \num{1.11}* & \num{1.27}**\\
 & (\num{1.32}) & (\num{1.29}) & (\num{0.57}) & (\num{0.54})\\
\midrule
Control average & NaN & NaN & NaN & NaN\\
Covariates &  & X &  & X\\
Num.Obs. & \num{11049} & \num{11049} & \num{11049} & \num{11049}\\
\bottomrule
\end{tabular}
...
\toprule
\multicolumn{1}{c}{ } & \multicolumn{2}{c}{Positive intention} & \multicolumn{2}{c}{No endogenous dropout} & \multicolumn{2}{c}{No exogenous dropout} \\
...
\hspace{1em}MatchMessage group & 3.25** & 2.94** & 0.43 & 0.30\\
\hspace{1em} & (1.48) & (1.50) & (0.77) & (0.87)\\
\hspace{1em}CoordMessage group & 0.90 & 1.36 & -0.14 & -0.09\\
\hspace{1em} & (1.50) & (1.37) & (0.78) & (0.77)\\
\hspace{1em}BothMessage group & 0.89 & 0.82 & 0.45 & 0.39\\
...
\hspace{1em}MatchMessage group & 2.51* & 1.72 & 0.27 & -0.41\\
\hspace{1em} & (1.34) & (1.47) & (0.65) & (0.72)\\
\hspace{1em}CoordMessage group & -0.83 & -0.92 & -0.05 & -0.14\\
\hspace{1em} & (1.35) & (1.35) & (0.66) & (0.66)\\
\hspace{1em}BothMessage group & 1.94 & 1.89 & 0.01 & -0.08\\
