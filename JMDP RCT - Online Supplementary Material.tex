...
\end{tabular}
\begin{tablenotes}
\item \emph{Note}: See Table 1 in the main manuscrpit for a detailed description of the intervention of each experimental group. The control arm is experimental group A. The experiment was not conducted during the week beginning December 27, 2021, and ending January 3, 2022, because JMDP was closed for the New Year's holiday.
\end{tablenotes}
\end{threeparttable}
\end{table}
...
\fontsize{8}{10}\selectfont
\begin{threeparttable}
\begin{tabular}[t]{>{\raggedright\arraybackslash}p{30em}cccc}
\toprule
\multicolumn{1}{c}{ } & \multicolumn{2}{c}{CT} & \multicolumn{2}{c}{Donation} \\
\cmidrule(l{3pt}r{3pt}){2-3} \cmidrule(l{3pt}r{3pt}){4-5}
  & (1) & (2) & (3) & (4)\\
\midrule
Experimental group B & \num{2.73} & \num{1.90} & \num{-0.47} & \num{-0.77}\\
...
\midrule
\addlinespace[0.3em]
\multicolumn{5}{l}{\textit{Linear combination test: Experimental group + Experimental group $\times$ Male}}\\
\hspace{1em}Experimental group B & 3.25** & 2.94** & 0.43 & 0.30\\
\hspace{1em} & (1.48) & (1.50) & (0.77) & (0.87)\\
\hspace{1em}Experimental group C & 0.90 & 1.36 & -0.14 & -0.09\\
\hspace{1em} & (1.50) & (1.37) & (0.78) & (0.77)\\
\hspace{1em}Experimental group D & 0.89 & 0.82 & 0.45 & 0.39\\
\hspace{1em} & (1.51) & (1.37) & (0.80) & (0.80)\\
Covariates &  & X &  & X\\
Num.Obs. & \num{11049} & \num{11049} & \num{11049} & \num{11049}\\
\bottomrule
\end{tabular}
...
\midrule
\addlinespace[0.3em]
\multicolumn{5}{l}{\textit{Linear combination test: Experimental group + Experimental group $\times$ First-Time Coordination}}\\
\hspace{1em}Experimental group B & 2.51* & 1.72 & 0.27 & -0.41\\
\hspace{1em} & (1.34) & (1.47) & (0.65) & (0.72)\\
\hspace{1em}Experimental group C & -0.83 & -0.92 & -0.05 & -0.14\\
\hspace{1em} & (1.35) & (1.35) & (0.66) & (0.66)\\
\hspace{1em}Experimental group D & 1.94 & 1.89 & 0.01 & -0.08\\
\hspace{1em} & (1.36) & (1.37) & (0.66) & (0.66)\\
Covariates &  & X &  & X\\
Num.Obs. & \num{11049} & \num{11049} & \num{11049} & \num{11049}\\
\bottomrule
\end{tabular}
