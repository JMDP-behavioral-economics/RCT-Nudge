...
\begin{figure}[H]
\includegraphics{JMDPRC~2/figure-latex/density-response-by-intention-1} \caption{Density of Response Speed by Intention (StatusQuo Group). \newline \emph{Note}: We excluded those who skipped CT.}\label{fig:density-response-by-intention}
\end{figure}
