...
\begin{figure}[H]
\includegraphics{JMDPRC~1/figure-latex/lm-interaction-gender-coordination-age-1} \caption{Heterogeneous Treatment Effects on CT, Donor Selection, and Donation by Sex, Age, and Experience Group}\label{fig:lm-interaction-gender-coordination-age}
\end{figure}
