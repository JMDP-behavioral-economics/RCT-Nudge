...
\begin{figure}[H]
\includegraphics{JMDPRC~4/figure-latex/density-response-by-intention-1-1} \caption{Distribution of Response Speed by Intention (StatusQuo Group vs. MatchMessage Group). \newline \emph{Note}: We excluded those who skipped CT. We only show the density up to 40 days after the HLA match letter was sent because there was no remarkable change in the response rate thereafter.}\label{fig:density-response-by-intention-1}
\end{figure}

\begin{figure}[H]
\includegraphics{JMDPRC~4/figure-latex/density-response-by-intention-2-1} \caption{Distribution of Response Speed by Intention (StatusQuo Group vs. CoordMessage Group). \newline \emph{Note}: We excluded those who skipped CT. We only show the density up to 40 days after the HLA match letter was sent because there was no remarkable change in the response rate thereafter.}\label{fig:density-response-by-intention-2}
\end{figure}

\begin{figure}[H]
\includegraphics{JMDPRC~4/figure-latex/density-response-by-intention-3-1} \caption{Distribution of Response Speed by Intention (StatusQuo Group vs. BothMessage Group). \newline \emph{Note}: We excluded those who skipped CT. We only show the density up to 40 days after the HLA match letter was sent because there was no remarkable change in the response rate thereafter.}\label{fig:density-response-by-intention-3}
\end{figure}
