...
BothMessage group & \num{-1.89} & \num{-1.28} & \num{-1.04} & \num{1.11} & \num{1.27} & \num{1.24}\\
 & (\num{1.90}) & (\num{1.93}) & (\num{1.92}) & (\num{1.02}) & (\num{0.94}) & (\num{0.80})\\
\midrule
Control average & 36.59 & 36.59 & 36.59 & 3.86 & 3.86 & 3.86\\
Covariates &  & X & X &  & X & X\\
Month FE &  &  & X &  &  & X\\
Num.Obs. & \num{11050} & \num{11049} & \num{11049} & \num{11050} & \num{11049} & \num{11049}\\
\bottomrule
...
\midrule
First-time coordination & N & 7016 & 1 & 7017\\
 & \% row & \num{99.99} & \num{0.01} & \num{100.00}\\
Second-time or more coordination & N & 3532 & 501 & 4033\\
 & \% row & \num{87.58} & \num{12.42} & \num{100.00}\\
All & N & 10548 & 502 & 11050\\
 & \% row & \num{95.46} & \num{4.54} & \num{100.00}\\
\bottomrule
\end{tabular}
\end{table}
