...
\date{Last updated on January 12, 2024}
...
\hspace{1em}H0: $B = C$ & $< 0.001$ & $0.012$ & $< 0.001$ & $< 0.001$\\
Num.Obs. & \num{1127} & \num{3006} & \num{1556} & \num{5296}\\
\bottomrule
\end{tabular}
\begin{tablenotes}
...
\cmidrule(l{3pt}r{3pt}){2-3} \cmidrule(l{3pt}r{3pt}){4-5}
 & Mean & S.D. & Mean & S.D.\\
\midrule
B & 0.0200 & 0.0559 & 0.0327 & 0.0414\\
C & -0.0033 & 0.0607 & 0.0227 & 0.0338\\
D & 0.0071 & 0.0613 & 0.0277 & 0.0378\\
Optimum &  &  & 0.0469 & 0.0518\\
\bottomrule
\end{tabular}
\begin{tablenotes}
\item 
...
\toprule
\multicolumn{1}{c}{ } & \multicolumn{3}{c}{Optimal treatment} \\
\cmidrule(l{3pt}r{3pt}){2-4}
 & B & C & D\\
\midrule
Male (= 1) & 0.65 & 0.54 & 0.65\\
Age & 34.88 & 41.84 & 39.44\\
Number of past coordinations & 1.48 & 1.66 & 1.71\\
Number of listed hospitals & 0.44 & 0.40 & 0.62\\
Number of hospitals listed with PBSC collection & 0.15 & 0.14 & 0.21\\
Number of hospitals listed with BM collection & 0.23 & 0.20 & 0.33\\
N & 4913 & 2683 & 3389\\
\bottomrule
\end{tabular}
\begin{tablenotes}
...
\cmidrule(l{3pt}r{3pt}){2-2} \cmidrule(l{3pt}r{3pt}){3-3} \cmidrule(l{3pt}r{3pt}){4-4} \cmidrule(l{3pt}r{3pt}){5-5}
 & (1) & (2) & (3) & (4)\\
\midrule
B & -0.0125 & -0.0054 & 0.1280*** & 0.0177\\
 & (0.0479) & (0.0287) & (0.0395) & (0.0214)\\
C & 0.0368 & -0.0152 & 0.0515 & -0.0115\\
 & (0.0487) & (0.0298) & (0.0408) & (0.0226)\\
D & -0.0673 & 0.0098 & 0.0495 & 0.0204\\
 & (0.0490) & (0.0291) & (0.0396) & (0.0221)\\
\bottomrule
\end{tabular}
\begin{tablenotes}
...
\cmidrule(l{3pt}r{3pt}){2-2} \cmidrule(l{3pt}r{3pt}){3-3} \cmidrule(l{3pt}r{3pt}){4-4}
 & (1) & (2) & (3)\\
\midrule
Age & 35.685 & 37.550 & < 0.001\\
Number of past coordinations & 1.658 & 2.725 & < 0.001\\
Number of listed hospitals & 0.397 & 1.584 & < 0.001\\
Number of hospitals listed with PBSC collection & 0.134 & 0.536 & < 0.001\\
Number of hospitals listed with BM collection & 0.200 & 0.937 & < 0.001\\
N & 9052 & 1933 & \\
\bottomrule
\end{tabular}
\begin{tablenotes}
