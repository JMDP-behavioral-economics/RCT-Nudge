...
\date{Last updated on January 14, 2024}
...
\begin{figure}[t]
\includegraphics{JMDPRC~2/figure-latex/rcf-policy-dist-1} \caption{Distribution of Predicted Treatment Effect}\label{fig:rcf-policy-dist}
\end{figure}
