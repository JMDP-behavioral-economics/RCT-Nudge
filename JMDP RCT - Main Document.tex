...
To provide a better understanding of our interventions and our data, we outline the coordination process leading up to the donation of stem cells by potential donors enrolled in the JMDP. First, when a potential donor is matched with a patient enrolled in the JMDP, the JMDP office sends the donor the HLA match letter.\footnote{Simultaneously, the JMDP office sends a social networking message to the matched donors, informing them that JMDP has sent the HLA match letter.} \revise{JMDP recommends in the letter that the matched donor responds within seven days.} The matched donor completes a questionnaire and responds to the letter, indicating their willingness to donate; this initiates the coordination process.
...
\addlinespace[0.3em]
\multicolumn{5}{l}{\textbf{Without control variables}}\\
...
\addlinespace[0.3em]
\multicolumn{5}{l}{\textbf{With control variables}}\\
\hspace{1em}B & 2.49 & 1.61 & 5.14* & 2.90*\\
\hspace{1em} & (3.57) & (2.07) & (3.11) & (1.70)\\
\hspace{1em}C & 3.24 & 0.32 & -2.11 & 2.37\\
\hspace{1em} & (3.59) & (2.12) & (2.97) & (1.74)\\
\hspace{1em}D & 4.27 & 4.68** & -2.60 & 2.22\\
\hspace{1em} & (3.59) & (2.15) & (3.00) & (1.74)\\
\bottomrule
\end{tabular}
\begin{tablenotes}
\item \emph{Note}: * $p < 0.1$, ** $p < 0.05$, *** $p < 0.01$. The robust standard errors are in parentheses. 
...
\caption{\label{tab:test-reg-subset}Heterogeneous Effects of Message on CT (Age cutoff: 30)}
\centering
\fontsize{9}{11}\selectfont
\begin{threeparttable}
...
\hspace{1em}Treatment B & -3.13 (1.93) & -2.27 (1.79) & -1.07 (1.66)\\
\hspace{1em}Treatment C & -0.16 (2.17) & 0.34 (2.02) & 0.84 (1.85)\\
\hspace{1em}Treatment D & -1.73 (2.04) & -1.21 (1.88) & -0.68 (1.70)\\
\hspace{1em}Control average & 6.80 & 5.60 & 4.40\\
\addlinespace[0.3em]
\multicolumn{4}{l}{\textbf{Older females (N = 3018)}}\\
\hspace{1em}Treatment B & -0.51 (0.92) & -0.43 (0.85) & -0.26 (0.81)\\
\hspace{1em}Treatment C & 0.48 (1.01) & 0.63 (0.95) & -0.06 (0.86)\\
\hspace{1em}Treatment D & 0.71 (1.01) & 0.51 (0.92) & -0.37 (0.82)\\
\hspace{1em}Control average & 3.55 & 2.98 & 2.70\\
\addlinespace[0.3em]
\multicolumn{4}{l}{\textbf{Young males (N = 1566)}}\\
\hspace{1em}Treatment B & 2.03 (2.02) & 1.74 (1.85) & 2.69 (1.70)\\
\hspace{1em}Treatment C & -1.66 (1.84) & -0.76 (1.72) & 0.17 (1.54)\\
\hspace{1em}Treatment D & 0.75 (2.02) & 1.61 (1.90) & 1.41 (1.67)\\
\hspace{1em}Control average & 7.76 & 6.37 & 4.71\\
\addlinespace[0.3em]
\multicolumn{4}{l}{\textbf{Older males (N = 5333)}}\\
\hspace{1em}Treatment B & 0.60 (1.01) & 0.65 (0.97) & -0.20 (0.87)\\
\hspace{1em}Treatment C & 0.04 (1.03) & -0.15 (0.98) & -0.23 (0.90)\\
\hspace{1em}Treatment D & 0.86 (1.06) & 0.89 (1.02) & 0.17 (0.92)\\
