...
\caption{\label{tab:reg-stock}Linear Probability Model of Intention and Avairability}
\centering
\fontsize{9}{11}\selectfont
\begin{threeparttable}
...
Treatment D & \num{0.008} & \num{0.008} & \num{0.006} & \num{0.007} & \num{0.024}** & \num{0.026}**\\
 & (\num{0.009}) & (\num{0.009}) & (\num{0.014}) & (\num{0.014}) & (\num{0.012}) & (\num{0.012})\\
\midrule
Control average & 0.8769 & 0.8769 & 0.5491 & 0.5491 & 0.2225 & 0.2225\\
Covariates &  & X &  & X &  & X\\
Num.Obs. & \num{11049} & \num{11049} & \num{11049} & \num{11049} & \num{11049} & \num{11049}\\
\bottomrule
\end{tabular}
...
Treatment D & \num{0.005} & \num{0.005} & \num{0.006} & \num{0.006} & \num{0.001} & \num{0.000}\\
 & (\num{0.007}) & (\num{0.007}) & (\num{0.006}) & (\num{0.007}) & (\num{0.006}) & (\num{0.006})\\
\midrule
Control average & 0.0619 & 0.0619 & 0.0544 & 0.0544 & 0.0450 & 0.0450\\
Covariates &  & X &  & X &  & X\\
Num.Obs. & \num{11049} & \num{11049} & \num{11049} & \num{11049} & \num{11049} & \num{11049}\\
\bottomrule
\end{tabular}
...
\caption{\label{tab:reg-stock-subset}Subsample Analysis for Primary Outcomes}
\centering
\begin{threeparttable}
\fontsize{9}{11}\selectfont
...
\hspace{1em}Treatment B & 0.008 (0.033) & -0.002 (0.045) & 0.032 (0.036)\\
\hspace{1em}Treatment C & 0.040 (0.031) & 0.034 (0.046) & 0.040 (0.037)\\
\hspace{1em}Treatment D & -0.011 (0.032) & -0.035 (0.044) & 0.057 (0.036)\\
\addlinespace[0.3em]
\multicolumn{4}{l}{\textbf{Older females (N = 3018)}}\\
\hspace{1em}Treatment B & -0.006 (0.013) & -0.009 (0.026) & 0.019 (0.021)\\
\hspace{1em}Treatment C & -0.012 (0.014) & -0.027 (0.028) & 0.002 (0.022)\\
\hspace{1em}Treatment D & -0.008 (0.013) & -0.004 (0.027) & 0.047** (0.022)\\
\addlinespace[0.3em]
\multicolumn{4}{l}{\textbf{Young males (N = 1566)}}\\
\hspace{1em}Treatment B & 0.064** (0.031) & 0.092** (0.036) & 0.066** (0.032)\\
\hspace{1em}Treatment C & 0.023 (0.032) & 0.023 (0.036) & -0.010 (0.031)\\
\hspace{1em}Treatment D & 0.060* (0.032) & 0.026 (0.036) & -0.025 (0.030)\\
\addlinespace[0.3em]
\multicolumn{4}{l}{\textbf{Older males (N = 5333)}}\\
\hspace{1em}Treatment B & 0.017 (0.013) & 0.021 (0.019) & 0.026 (0.017)\\
\hspace{1em}Treatment C & -0.003 (0.014) & -0.015 (0.021) & 0.015 (0.018)\\
\hspace{1em}Treatment D & 0.004 (0.013) & 0.011 (0.020) & 0.021 (0.018)\\
\bottomrule
\end{tabular}
\begin{tablenotes}
\item Notes: The robust standard errors are in parentheses. The age category is defined as under 30 years old or older. We control the number of past coordination, the number of hospitals per 10 square kilometers, the number of hospitals with PBSC collection per 10 square kilometers, the number of hospitals with BM collection per 10 square kilometers, month dummies, and week dummies.
\end{tablenotes}
\end{threeparttable}
\end{table}
