...
\caption{\label{tab:reg-coordinate-subset}Subsample Analysis for Coordination Process}
\centering
\begin{threeparttable}
\fontsize{9}{11}\selectfont
\begin{tabular}[t]{lccc}
...
\caption{\label{tab:reg-stock-subset-2}Subsample Analysis for Primary Outcomes}
\centering
\begin{threeparttable}
\fontsize{9}{11}\selectfont
\begin{tabular}[t]{lccc}
...
\caption{\label{tab:reg-coordinate-subset-2}Subsample Analysis for Coordination Process}
\centering
\begin{threeparttable}
\fontsize{9}{11}\selectfont
\begin{tabular}[t]{lccc}
