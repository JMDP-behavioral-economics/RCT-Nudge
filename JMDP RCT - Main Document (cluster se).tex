...
\begin{figure}[t]
\includegraphics{JMDP RCT - Main Document (cluster se)_files/figure-latex/stock-diff-mean-1} \caption{Sample Averages of Response, Positive Intention, and CT by Treatments.\newline \emph{Note}: Error bars show standard errors of the mean. For the statistical test, we used robust standard errors.}\label{fig:stock-diff-mean}
\end{figure}
...
\begin{figure}[t]
\includegraphics{JMDP RCT - Main Document (cluster se)_files/figure-latex/coordinate-diff-mean-1} \caption{Sample Averages of Candidate Selection, Final Consent, and Donation by Treatments.\newline \emph{Note}: Error bars show standard errors of the mean. For the statistical test, we used robust standard errors.}\label{fig:coordinate-diff-mean}
\end{figure}
