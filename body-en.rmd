...
Early Coordinationメッセージは早いコーディネーションが患者の移植率を高めることを提示している。適合通知への返信が遅れることによってコーディネーション期間が長くなると、患者の移植率が減少してしまう。したがって、このメッセージは患者への移植によって得られる効用が経時的に減衰していくことを示している。第\@ref(intro)節で述べたように、将来でも患者を助けられると考えている適合ドナーは適合通知への返信期間を長くする可能性がある。これは時間に関する限界効用の低下が小さいと信じていることで生じる。このメッセージを読んだ適合ドナーは限界効用の低下の程度が予想よりも大きいということを学習して、最適な返信期間を短くするだろう。したがって、仮にこのメッセージが適合通知への返信率を高めるほど提供の効用水準を高めていなくても、返信者の返信期間の分布が左にシフトしている可能性がる。
