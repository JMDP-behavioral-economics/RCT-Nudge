...
同種造血幹細胞移植（allogenic stem cell transplantation）は白血病などの血液疾患に対して最も再発率が低い治療法の一つである。この治療法は
（１）大量抗がん剤や放射線によって病的な細胞と健康な造血幹細胞を同時に死滅させ、（２）他者から提供された健康な造血幹細胞を移植する方法である。造血幹細胞の移植は、ドナーのHLAと呼ばれる白血球の型が患者のそれと一致していることが一つの条件となる[^hapro]。ランダムな二人の間でHLAが一致する確率は1\%未満であるのに対して、最もHLAが一致する確率が高いのは兄弟姉妹であり、マッチングする確率はおよそ30\%である。また、親子間で一致する確率は非常に低い。もし血縁者の中に適合するドナーがいなければ、患者は非血縁者から造血幹細胞提供ドナーを探さなければならない。日本においては、日本骨髄バンク（以降、JMDPとする）を介して非血縁者ドナーを探す。しかしながら、JMDPを介したコーディネーションは移植までの期間が長く、60%の患者しか移植を受けられないという問題がある[@Hirakawa2018]。

[^hapro]: 近年、ハプロ移植と呼ばれる、HLAが半合致した血縁者間の移植が普及している．また、さい帯血移植と呼ばれる、母子を結ぶさい帯と胎盤の中に含まれる血液細胞の移植も普及している．骨髄移植と異なり、さい帯血移植はHLAの完全一致という条件を満たしていなくても移植できる．

患者の生存率を高めるための施策は二つある。第一に、ドナーとなり得る人の数を増やす施策によって、患者のマッチング確率を高める。患者のHLAと一致するドナーが4人未満であるときと比較して、患者のHLAと一致するドナーが200人以上いるとき、患者の移植到達率は45%から74%に上昇し、移植までの期間の中央値も約2週間短くなる[@Hirakawa2018]。しかしながら、2000年から2015年にかけてJMDPのドナー候補者数はおよそ2倍になっているが、初回のマッチング確率は5\%程度しか増加していない[@Takanashi2016][^reason]。すなわち、ドナーとなり得る人の数を増やすことの限界便益が小さいので、ドナープールの規模を拡大するような施策はあまり有効ではないだろう。

[^reason]: 白血球の型が希少な人が新規加入する確率が低いからである。

第二に、ドナープールの中で提供を断る可能性が低い人の割合を高めることで、プールの質に貢献する施策である。@Hirakawa2018 は73%のコーディネーションがその第一段階である確認検査の前で中断していることを示している（コーディネーションの流れは第 @sec-background 節を参照）。さらに、彼らは中断の主な原因はドナー側にあることを明らかにしている。したがって、提供に積極的なドナーの比率が多いプールを作ることで、移植到達率を高めることができるだろう。また、ドナープールの質を高める施策の限界便益はドナープールの規模を拡大する施策のそれよりも高いといえる。

本研究はドナープールの質を改善する施策として情報提供の有効性を検討する。JMDPに登録した人がある患者のドナー候補者になるとき、その人はJMDPから適合通知を受け取る。そして、適合通知に提供の意思を示して返信する人が移植のコーディネーションを受ける。我々はその適合通知にJMDPが公表している情報に基づいてメッセージを追加し、その効果を検証するフィールド実験を2021年9月から2022年2月にかけて実施した。我々はこの時期にドナー候補者として適合通知を受け取った人に関する（適合通知への返信の有無や提供意向の有無を含む）コーディネーション過程のデータをJMDPから提供してもらい、情報提供の効果を分析する。

介入メッセージは2種類ある。一つは骨髄バンクに登録した患者とHLA型が一致するドナー登録者が少ないという情報である。JMDPでは、一人の患者につき、複数のドナー候補者が同時にコーディネーションを受けるので、幹細胞提供は公共財の性質を持つ。同時に進行しているドナー候補者が少ないという情報はドナー候補者が他のドナー候補者が過度に複数いるという期待に起因するフリーライド行動を防ぐことを意図している。もう一つの情報は骨髄バンクに登録した患者の約半数しか移植を受けられないというものである。これは単純に幹細胞提供という利他的行動の価値を高めることを目的としている。フィールド実験の結果、骨髄バンクに登録した患者とHLA型が一致するドナー登録者が少ないという情報が若年男性の適合通知の返信と返信時に示す提供意向を高めることが明らかになった。
